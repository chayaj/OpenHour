...
public class YelpCustomListViewAdapter extends ArrayAdapter<Business> {

    Context context;

    public YelpCustomListViewAdapter(Context context, int resourceId, List<Business> items) {
